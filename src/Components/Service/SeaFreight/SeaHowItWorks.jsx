...
const SeaHowItWorks = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white py-12 px-4 mt-8  text-center">
        <p className="text-[22px] sm:text-[28px] mb-15 md:text-[32px] leading-snug text-gray-500 max-w-4xl mx-auto">
          Professional Freight is your trusted partner for global logistics.
          With experience and a vast network,{" "}
          <span className="text-black font-semibold">
            we deliver your cargo safely and on time,{" "}
          </span>
          <span className="text-black font-semibold underline decoration-yellow-400 decoration-4 underline-offset-4">
