...
const WhyOutports = () => {
  return (
    <>
      <section className="aboutbg py-20 px-6 md:px-20 mt-10 font-sans text-[#1a1a1a]  relative bg-white overflow-hidden">
